...
},{"./bundle-url":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"select/select.scss":[function(require,module,exports) {
...
var Select = /*#__PURE__*/function () {
  function Select(selector, config) {
    ...
    _renderSelect.add(this);

    this.selectorElement = document.querySelector(selector);
    this._isOpened = false;
    this.configData = config;

    _classPrivateMethodGet(this, _renderSelect, _renderSelect2).call(this);
...
var _renderSelect2 = function _renderSelect2() {
  this.selectorElement.classList.add("wrap");
  var placeholder = this.configData.placeholder;
...
var _select2 = require("./select/select.js");

var select = new _select2.Select("#select", {
